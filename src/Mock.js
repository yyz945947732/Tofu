...
const __idMaker = function() {
  let id = 1;
  __idMaker.cleanId = function() {
    id = 1;
  }
  return function() {
    return id++;
...
const __arrayMockAction = function(obj, props, num) {
  let i = 0;
...
const __propsController = function(props, host) {
...
const __getValueByType = function(type, value) {
  switch (type) {
    case 'number':
...
const __objectAction = function(value) {
  if (__isObject(value)) {
...
const __stringAction = function(type) {
